...
MEDIAVAULT_AUTH_CLIENT_COOKIE_NAME=site_auth_client
MEDIAVAULT_AUTH_SESSION_COOKIE_NAME=site_session
```

Media key derivation salt:

```env
MEDIAVAULT_MEDIA_KEY_DERIVATION_SALT=local-streamer-video-v1
```
